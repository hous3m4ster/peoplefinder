...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: message_types/group_chat_created_message.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: message_types/group_chat_created_message.js</h1>
...
/*************************************
 * The GroupChatCreatedMessage class *
 *************************************/

/**
 * A message which indicates a group chat has been created
 *
 * @extends Message
 */
class GroupChatCreatedMessage extends Message {
	/**
...
module.exports = GroupChatCreatedMessage;
</code></pre>
        </article>
    </section>
