...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: message_types/new_chat_title_message.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: message_types/new_chat_title_message.js</h1>
...
/*********************************
 * The NewChatTitleMessage class *
 *********************************/

/**
 * A message which contains the new title of the chat
 *
 * @extends Message
 */
class NewChatTitleMessage extends Message {
	/**
	 ...
	 */
	get title() {
		return this.rawMessage.new_chat_title;
	}
...
module.exports = NewChatTitleMessage;
</code></pre>
        </article>
    </section>
