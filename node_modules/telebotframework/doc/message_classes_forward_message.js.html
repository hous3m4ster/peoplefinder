...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: message_classes/forward_message.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: message_classes/forward_message.js</h1>
...
/**
 * A message which contains a forwarded message
 *
 * @extends TextMessage
 */
class ForwardMessage extends TextMessage {
	/**
	 * Creates a new ForwardMessage object
	 *
	 * @param {Object} message	A raw message object from an update
	...
	/**
	 * The original sender of the message, not the one who forwarded it
	 */
	get originalSender() {
		return this.rawMessage.forward_from;
	}

	/**
	 * The timestamp of the original message, not this one
	 */
	get originalDate() {
		return this.rawMessage.forward_date;
	}
