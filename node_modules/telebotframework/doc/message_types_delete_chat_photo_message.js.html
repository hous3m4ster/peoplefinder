...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: message_types/delete_chat_photo_message.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: message_types/delete_chat_photo_message.js</h1>
...
/*********************************
 * The DeleteChatPhotoMessage class *
 *********************************/

/**
 * A message which indicates the photo of the chat has been deleted
 *
 * @extends Message
 */
class DeleteChatPhotoMessage extends Message {
	/**
...
module.exports = DeleteChatPhotoMessage;
</code></pre>
        </article>
    </section>
