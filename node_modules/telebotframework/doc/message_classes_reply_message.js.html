...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: message_classes/reply_message.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: message_classes/reply_message.js</h1>
...
class ReplyMessage extends TextMessage {
	...
	/**
	 * The replied-to message. Note that it may be any type of message. If it matters, you have to check which type it is yourself
	 *
	 * @readonly
	 */
	get originalMessage() {
