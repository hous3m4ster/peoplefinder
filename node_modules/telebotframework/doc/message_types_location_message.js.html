...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: message_types/location_message.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: message_types/location_message.js</h1>
...
/*****************************
 * The LocationMessage class *
 *****************************/

/**
 * A message which contains a location
 *
 * @extends Message
 */
class LocationMessage extends Message {
	 ...
	 *
	 * @type {Object}
	 * @property {Float} latitude	Latitude of the position
	 * @property {Float} longitude	Longitude of the position
	 * @readonly
	 */
	get location() {
		return this.rawMessage.location;
	}
}
