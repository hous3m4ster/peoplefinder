...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: message_types/supergroup_chat_created_message.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: message_types/supergroup_chat_created_message.js</h1>
...
/******************************************
 * The SupergroupChatCreatedMessage class *
 ******************************************/

/**
 * A message which indicates a supergroup chat has been created
 *
 * @extends Message
 */
class SupergroupChatCreatedMessage extends Message {
	/**
...
module.exports = SupergroupChatCreatedMessage;
</code></pre>
        </article>
    </section>
