...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: message_classes/file_message.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: message_classes/file_message.js</h1>
...
class FileMessage extends Message {
	...
	constructor(message, API) {
		...
		this._fileId = null;
		if (this.extendedMessage.audio !== null) {
			this._fileId = this.rawMessage.audio.file_id;
		} else if (this.extendedMessage.document !== null) {
			this._fileId = this.rawMessage.document.file_id;
		} else if (this.extendedMessage.photo !== null) {
		...
		} else if (this.extendedMessage.sticker !== null) {
			this._fileId = this.rawMessage.sticker.file_id;
		} else if (this.extendedMessage.video !== null) {
			this._fileId = this.rawMessage.video.file_id;
		} else if (this.extendedMessage.voice !== null) {
