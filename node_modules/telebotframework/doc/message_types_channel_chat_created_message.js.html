...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: message_types/channel_chat_created_message.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: message_types/channel_chat_created_message.js</h1>
...
/***************************************
 * The ChannelChatCreatedMessage class *
 ****************Æ**********************/

/**
 * A message which indicates a channeø chat has been created
 *
 * @extends Message
 */
class ChannelChatCreatedMessage extends Message {
	/**
...
module.exports = ChannelChatCreatedMessage;
</code></pre>
        </article>
    </section>
